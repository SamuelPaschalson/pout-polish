  ...
  const values = [
    {
      ...
      description:
        'Every product is crafted with care and passion, ensuring the highest quality for your lips.',
    },
    {
      icon: <LeafIcon />,
      title: 'Natural Ingredients',
      description:
        'We source only the finest natural and organic ingredients for safe, nourishing lip care.',
    },
    {
      icon: <SparkleIcon />,
      title: 'Radiant Results',
      description:
        'Our products deliver visible results - softer, smoother, and more beautiful lips.',
    },
  ];
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <span className="text-rose-400 font-serif italic text-2xl">
                Our Story
              </span>
              ...
              <p className="text-stone-600 text-lg leading-relaxed">
                Welcome to Pout & Polish, where we believe that beautiful lips
                start with proper care. Founded with a passion for natural
                beauty, we create luxurious lip care products that nourish,
                protect, and enhance your natural beauty.
              </p>
              <p className="text-stone-600 text-lg leading-relaxed">
                Every product in our collection is thoughtfully formulated with
                natural ingredients, ensuring your lips get the love and care
                they deserve. From our bestselling lip scrubs to our hydrating
                lip oils, each item is designed to give you that perfect pout.
              </p>
            </div>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {values.map((value, i) => (
              <div
                key={i}
                className="text-center p-8 rounded-3xl bg-rose-50/50 hover:bg-rose-50 transition-colors"
              >
      ...
      <section className="py-24 bg-gradient-to-r from-rose-50 to-amber-50">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-stone-600 text-lg leading-relaxed mb-8">
            At Pout & Polish, our mission is simple: to help every person feel
            confident in their own skin. We believe that self-care is an act of
            self-love, and taking care of your lips is an essential part of that
            journey. Our products are designed to make lip care enjoyable,
            effective, and accessible to everyone.
          </p>
          <p className="text-stone-600 text-lg leading-relaxed">
            We&apos;re committed to using sustainable practices and natural
            ingredients, because we care about your health and our planet. When
            you choose Pout & Polish, you&apos;re choosing quality, care, and a
            brand that truly puts you first.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 bg-stone-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <p className="text-stone-400 text-lg mb-8">
            Get in touch with us today and discover the perfect products for
            your lips.
          </p>
          <button
